...
public class ApigccTest {
    ...
    public void testApigcc() {
        Options options = new Options()
                ...
                .jar(Paths.get("src/main/resources/lib/apigcc-model-1.0-SNAPSHOT.jar"))
                .id("apigcc")
                .title("示例接口文档")
        ...
        Path template = options.getOutPath().resolve("../../src/main/resources/template.adoc");
        Path templateHtml = options.getOutPath().resolve("../../src/main/resources/template.html");
